  ...
  projects: [
    {
      ...
      images: <>
        <img className="w-full sm:w-2/5" height={540} width={918} loading="lazy" src="/screenshots/playlist-editor.webp"  alt="playlist editor" />
        <img className="w-full sm:w-2/5" height={540} width={918} loading="lazy" src="/screenshots/playlist-editor-exporting.webp" alt="playlist editor while exporting a project" />
      </>,
    ...
    },
    {
      ...
      images: <>
        <img className="w-2/5 sm:w-2/7" height={3094} width={1442} loading="lazy" src="/screenshots/home-page.webp" alt="Vena's radio home page" />
        <img className="w-2/5 sm:w-2/7" height={3094} width={1442} loading="lazy" src="/screenshots/feed-page.webp" alt="Vena's radio feed page" />
      </>,
